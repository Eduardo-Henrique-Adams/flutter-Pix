...
class TransferirInformacoes extends StatefulWidget {
  const TransferirInformacoes({ Key? key }) : super(key: key);

  @override
  _TransferirInformacoesState createState() => _TransferirInformacoesState();
}

class _TransferirInformacoesState extends State<TransferirInformacoes> {
  @override
            ...
            Row(
              children: [
                 Padding(
                   ...
                   child: Text('CPF:',style: TextStyle(color: Colors.grey, fontSize: 20)),
                 ),
                 Padding(
                   padding: const EdgeInsets.only(top: 35, bottom: 0,left: 25, right: 0),
                   child: Text('CPF do Fulano',style: TextStyle(color: Colors.black87, fontSize: 20)),
                 )
              ],
            ),
            Row(
              children: [
                 ...
                 Padding(
                   ...
                   child: Text('Instituição:',style: TextStyle(color: Colors.grey, fontSize: 20)),
                 ),
                 Padding(
                   padding: const EdgeInsets.only(top: 30, bottom: 0,left: 25, right: 0),
                   child: Text('Banco do Fulano',style: TextStyle(color: Colors.black87, fontSize: 20)),
                 )
              ],
            ),
            Padding(
              padding: const EdgeInsets.only(top: 143.4, bottom: 0,left: 0, right: 0),
              child: Container(
                height: 65,
                width: MediaQuery.of(context).size.width,
