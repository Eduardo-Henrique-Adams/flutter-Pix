...
class ChaveAleatoria extends StatefulWidget {
  const ChaveAleatoria({ Key? key }) : super(key: key);

  @override
  _ChaveAleatoriaState createState() => _ChaveAleatoriaState();
}

class _ChaveAleatoriaState extends State<ChaveAleatoria> {
  @override
        ...
        children: [
           Container(
              ...
              child: Padding(
                ...
                child: Text('Informe o Chave aleatoria para criar a chave Pix', style: TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.w600),textAlign: TextAlign.center,),
              ),
            ),
