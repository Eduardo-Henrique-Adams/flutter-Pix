       ...
       body: Column(
        ...
        children: [
           Container(
              ...
              color: Colors.blue,
              child: Padding(
                padding: const EdgeInsets.only(top: 30, bottom: 0,left: 80, right:80),
                child: Text('Informe o E-mail para criar a chave Pix', style: TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.w600),textAlign: TextAlign.center,),
              ),
            ),
