...
class NumCelular extends StatefulWidget {
  const NumCelular({ Key? key }) : super(key: key);

  @override
  _NumCelularState createState() => _NumCelularState();
}

class _NumCelularState extends State<NumCelular> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Nava chave'),
      ),
      body: Column(
        ...
        children: [
           Container(
              ...
              child: Padding(
                ...
                child: Text('Informe celular para criar a chave Pix', style: TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.w600),textAlign: TextAlign.center,),
              ),
            ),
